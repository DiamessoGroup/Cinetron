    ...
    <div class="container-fluid flex" id="videoContent">
        ...
        <div class="embed-responsive embed-responsive-16by9">
            <iframe ng-src="{{youtubeLinkFull}}" frameborder="0" width="1100" height="618.75" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
            <!-- <h2>Black Panther 1</h2>
    ...
    <footer>
        ...
        <div class="w3-row">
            ...
            <div class="w3-col s8 m10" id="footerTrailerContent">
                <p>{{trailerDetailTitle}}
                    <span class="w3-hide-small w3-right"><small>Run Time: <span class="movieSmallDetails">{{trailerDetailRuntime}} min</span></small> - <small>Release Year: <span class="movieSmallDetails">{{trailerDetailReleaseYear}}</span></small></span>
                </span>
                </p>
            </div>
            <div class="w3-col s2 m1">
